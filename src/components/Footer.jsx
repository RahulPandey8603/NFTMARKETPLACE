...
export default function Footer() {
  ...
  const companyLinks = ["Home", "About", "Marketplace", "Popular Collection", "Launchpad","Auction"];
  const contactInfo = [
    {
      icon: <MdEmail />,
      value: "rahul.pandey2021@vitbhopal.ac.in",
    },
    {
      icon: <MdPhoneInTalk />,
  ...
  return (
    <Container>
      <div className="row">
        ...
        <p className="description">the homepage of NFT's</p>
